...
import com.company.museumquests.QuestList
import com.company.museumquests.Start
        ...
        rootRef1.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (post.toString() == "true") {
                    ...
                    Toast.makeText(applicationContext,getString(R.string.donthavepermis), Toast.LENGTH_LONG).show()
            }
        })
    }
